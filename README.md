...
- **Three-node concurrent update** — two offline WebDAV overwrites of one path converge in either recovery order, then remain stable after restart and a later update (`three-node-offline-concurrent-update.sh`)
